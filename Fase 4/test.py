...
print(f"")
print(f"Testing _binary_outputs()")
print(f"")
print(f"3 = {Netw._binary_outputs(3)}")
print(f"")
print(f"------- test 8 end -------")
...
Net = Netw.append(Com_1,Net)
Net = Netw.append(Com_2,Net)
...
Net_1 = Netw.append(Com_1,Net_1)
Net_1 = Netw.append(Com_2,Net_1)
Net_1 = Netw.append(Com_3,Net_1)
...
w = [[36,25,25],[36563236,63425,4433660],[36,25,25]]
print(f"Testing sorting the network with correct comparators")
print(f"")
print(f"{Net}")
print(f"List before: {w}")
...
print(f"------- test 8.5 begin -------")
print(f"")
print(f"Testing _binary_outputs()")
print(f"")
print(f"3 = {Netw._binary_outputs(3)}")
print(f"")
print(f"------- test 8.5 end -------")
